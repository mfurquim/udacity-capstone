...
\hypertarget{andrew-ng}{%
\section{Andrew Ng}\label{andrew-ng}}
...
\(U = \begin{bmatrix} \textpipe & \textpipe & & \textpipe & & \textpipe\\ u^1 & u^2 & \cdots & u^k & \cdots & u^n\\ \textpipe & \textpipe & & \textpipe & & \textpipe \end{bmatrix} \in \mathbb{R}^{n \times n}\)

\(x\in\mathbb{R}^n\rightarrow z\in\mathbb{R}^k\)

\(U_{reduce} = \begin{bmatrix} \textpipe & \textpipe & & \textpipe\\ u^1 & u^2 & \cdots & u^k\\ \textpipe & \textpipe & & \textpipe \end{bmatrix} \in \mathbb{R}^{n \times k}\)
